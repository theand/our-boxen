...
github "nginx",       "1.7.0"
github "nodejs",      "5.0.7.2.theand", :repo => "theand-boxen/puppet-nodejs"
...
# github "ccleaner",  "1.1.1.3", :repo => "theand-boxen/puppet-ccleaner"
# github "fonts",  "0.0.7", :repo => "theand-boxen/puppet-fonts"
# github "mysql_workbench",  "0.0.7", :repo => "theand-boxen/puppet-mysql_workbench"
# github "haroopad",  "0.0.4", :repo => "theand-boxen/puppet-haroopad"
# github "p4merge",  "0.0.8", :repo => "theand-boxen/puppet-p4merge"
# github "sourcetree",  "1.0.5", :repo => "theand-boxen/puppet-sourcetree"
# github "appcleaner",  "1.0.4", :repo => "theand-boxen/puppet-appcleaner"
