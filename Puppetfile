...
# github "gcc",         "3.0.2"
github "git",         "2.7.11"
github "homebrew",    "2.0.0.12.theand", :repo => "theand-boxen/puppet-homebrew"
github "inifile",     "1.4.2", :repo => "puppetlabs/puppetlabs-inifile"
github "nginx",       "1.6.0"
github "nodejs",      "5.0.5.1.theand", :repo => "theand-boxen/puppet-nodejs"
...
# github "appcleaner",  "1.0.3", :repo => "theand-boxen/puppet-appcleaner"
