...
Gem::Specification.new do |s|
  ...
  s.authors = ["John Barnette", "Will Farrington", "David Goodlad", "Mike McQuaid"]
  s.date = "2015-06-22"
  s.description = "Manage Mac development boxes with love (and Puppet)."
  s.email = ["jbarnette@github.com", "wfarr@github.com", "dgoodlad@github.com", "mikemcquaid@github.com"]
